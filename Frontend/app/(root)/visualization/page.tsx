  ...
  const handleCopy = () => {
    ...
    return (
        <div className='mx-auto bg-feature-bg bg-center bg-no-repeat'>
            <h1 className='font-bold text-center text-5xl my-6 text-black mx-auto'>Data Visualization Code Generator</h1>
            <h4 className='py-3 text-center text-xl font-medium'>Visualization Code Snippet with Explanation</h4>
            <p className='py-2 text-center text-xl font-medium'>This tool is a simple tool that allows you to generate Matplotlib, Plotly, Seaborn Code snippet based on your prompts for your Data Visualization Task</p>
            <form onSubmit={handleSubmit} className='flex flex-col justify-center gap-5 mx-auto my-5' onKeyDown={handleKeyDown}>
                ...
                <button className='bg-green-600 text-white text-lg font-semibold rounded-md hover:bg-red-500 py-2 px-4 w-fit items-center mx-auto'>Generate Data Visualization Code snippet</button>
            </form>
          ...
          />
                        ...
                        <h3 className='font-semibold text-2xl text-blue-600'>Explanation of this Data Visualization Code snippet:</h3>
